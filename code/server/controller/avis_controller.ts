...
class AvisController {
    ...
    public insert = async (req: Request, res: Response) => {
        // insertation
        const results = await new AvisRepository().insert({...req.body,date:new Date});
