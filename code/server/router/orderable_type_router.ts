...
import OrderableTypeController from "../controller/orderable_type_controller";

class OrderableTypeRouter{
    ...
    public getRoutes = () => {
         // créer une route /api accessible en GET
            ...
            this.router.get('/', new OrderableTypeController().index);   
            
            //variable de route: précédée par un:; suivie du nom de la variable
            this.router.get('/:id', new OrderableTypeController().selectOne); 
...
export default OrderableTypeRouter;