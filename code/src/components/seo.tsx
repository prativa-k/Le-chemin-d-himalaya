import type { SeoProps } from "../props/seo_props";
...
const Seo = ({ title, description, url }: SeoProps) => {
	return (
		<>
			...
			{/* image: 1200*630 */}
			<meta property="og:image" content={`https://lechemindhimalaya/img/og_banner.png`} />
			<meta
			...
			<meta name="twitter:description" content={`Voyagez au cœur des saveurs du Népal et de l’Inde à Évry 91000. Currys, momos, tandoori et plats traditionnels servis dans une ambiance conviviale. - ${description}`} />
			{/* image: carrée*/}
			<meta name="twitter:image" content={`https://lechemindhimalaya/img/twitter_card.png`} />
		</>
	);
};
